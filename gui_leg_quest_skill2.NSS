...
void main(int iQuestID, int iNPC, int iObj1, int iObj2, int iObj3, int iObj4, int iObj5, int iAdvanceNPC, int iQuestType)
{
	...
	while(SQLFetch())
	{
		...
		iSkill = StringToInt(SQLGetData(10));
		iSkillDC = StringToInt(SQLGetData(12));
	}
